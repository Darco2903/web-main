...
import { getCookie, IS_MOBILE, wait } from "web-common";
...
export default {
    ...
    methods: {
        ...
        async saveIcon() {
            ...
            if (this.iconEdited) {
                if (!this.iconRemoved) {
                    const blob = await fetch(this.userIcon).then((res) => res.blob());
                ...
                <div class="data-section" id="username-section">
                    <div class="data-edit">
                        <div class="username-content">
                            <input type="text" id="username-input" placeholder="Username" v-model="user.name" />
                        </div>
